...
class CommentRepositoryTest {
    ...
    void findAllByArticleId() {
        /* Case 1: 4번 게시글의 모든 댓글 조회 */
        {
            ...
            Comment a = new Comment(1L, article, "댓글1", "작성자1");
            Comment b = new Comment(2L, article,"댓글2", "작성자2");
            Comment c = new Comment(3L, article,"댓글3", "작성자3");
        ...
        /* Case 2: 1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> comments = commentRepository.findAllByArticleId(articleId);
            //3. 예상 데이터
            Article article = new Article(1L, "rrrr", "rrr");
